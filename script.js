    ...
    const historia = [
        ...
        {
            texto: "Na sua Nave Espacial Estrelar, chega a um planeta desconhecido chamado Gaura.",
            escolhas: [
        ...
        {
            texto: "Após chegar no planeta desconhecido, a inteligência artifícial de bordo sugere analisar amostras de solo.",
            escolhas: [
        ...
        {
            texto: "Ao chegar na outra dimensão depara-se com um mundo repleto de encanto, onde as casas são feitas de cogumelos e os animais de estimação são dragões magestosos, um mundo onde a magia defenitivamente prevalece.E agora?",
            escolhas: [
        ...
        {
            texto: "Com a sua Nave Espacial Solar, encontra vida extraterrestre num planeta chamado Trillium. ",
            escolhas: [
        ...
        {
            texto: "Depois de trocar informações tem a oportunidade de trazer a vida infinita para o seu planeta. O que decide fazer?",
            escolhas: [
